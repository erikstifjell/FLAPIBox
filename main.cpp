...
int main(int main_argc, char *main_argv[])
{
	...
	for(unsigned int n = 0; n < gDisplays.size(); ++n)
	{
		...
		u8g2.setFontRefHeightText();
		u8g2.setFontPosTop();
		u8g2.drawStr(0, 0, " ____  _       _    ___   _");
		u8g2.drawStr(0, 7, "|  __|| |     / \\  |   \\ | |");
		u8g2.drawStr(0, 14, "| |_  | |    / O \\ |  O || |");
		u8g2.drawStr(0, 21, "|  _| | |   /  _  \\|  _/ | |");
		u8g2.drawStr(0, 28, "| |   | |__ | | | || |   | |");
		u8g2.drawStr(0, 35, "|_|   |____||_| |_||_|   |_|");
		u8g2.drawStr(0, 42, " _   _  _  _");
		u8g2.drawStr(0, 49, "| ) / \\  \\/");
		u8g2.drawStr(0, 56, "|_) \\_/ _/\\_");
		if(gDisplays.size() > 1)
		{
